...
Você também pode reiniciar a máquina virtual a partir do vSphere usando a opção *Reiniciar convidado* do VMware. Consulte o https://developer.broadcom.com/powercli/latest/vmware.vimautomation.core/commands/restart-vmguest/["Restart-VMGuest cmdlet na referência de cmdlets do VMware vSphere PowerCLI da Broadcom."^]
