...
[NOTE]
====
O pacote "WFA para gerenciamento de Clustered Data ONTAP" está incluído no WFA 5.1, portanto, não é necessário baixar este pacote da NetAppStorage Automation Store e instalá-lo separadamente em seu servidor WFA, como era necessário anteriormente. https://mysupport.netapp.com/site/products/all/details/ocwfa/downloads-tab["Download WFA"^]
